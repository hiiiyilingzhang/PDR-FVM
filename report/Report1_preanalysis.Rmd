...
all.anchors <- FindIntegrationAnchors(object.list = list, anchor.features = features)
finalData <- IntegrateData(anchorset = all.anchors)
finalData
# Set integrated as the active assay
# DefaultAssay(finalData) <- "integrated"
```